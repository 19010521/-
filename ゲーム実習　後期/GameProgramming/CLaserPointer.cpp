...
//幅と奥行きの設定
//Set(幅,奥行)
void CLaserPointer::Set(float w, float d){
	//スケール設定
...
void CLaserPointer::Collision(CCollider *m, CCollider *y){
	//共に球コライダの時
